#' Wrapper function of \code{MatD} class
#'
...
#' @rdname MatD-class
#' @export
#' @param x (optional, default= an empty \code{distributionD} object) a list of
...
#' @return A \code{MatD} object
#' @examples
#'
#' # bulding an empty 10 by 4 matrix of histograms
#' MAT <- MatD(nrows = 10, ncols = 4)
MatD <- function(x = NULL, nrows = 1, ncols = 1, rownames = NULL, varnames = NULL, by.row = FALSE) {
  MAT <- new("MatD",
    nrows = nrows,
    ncols = ncols,
    ListOfDist = x,
...
# overriding of "[" operator for MatD object ----
#' extract from a MatD Method [
#' @name [
#' @rdname extract-methods
#' @aliases [,MatD,ANY,ANY,ANY-method
#' [,MatD-method
#' @description This method overrides the "[" operator for a  \code{matD} object.
#' @param x a \code{matD} object
...
#' @return A \code{MatD} object
#' @examples
#' D <- XXX # the BLOOD dataset
#' SUB_D <- XXX[c(1, 2, 5), c(1, 2)]
...
setMethod(
  ...
  function(x, i, j, ..., drop = TRUE) {
    ...
    if (min(i) <= 0 | min(j) <= 0) {
      stop("negative indexes are not allowed in subsetting [,] a MatD object")
    }
    ...
    if(length(i)==1 && length(j)==1) x<-x@M[i,j][[i]]
    return(x)
  }
)
# methods for getting information from a MatD

setGeneric("get.MatD.nrows", function(object) standardGeneric("get.MatD.nrows"))
#' Method get.MatD.nrows
#' @name get.MatD.nrows
#' @description It returns the number of rows of a \code{MatD} object
#' @param object  a \code{MatD} object
#' @return An integer, the number of rows.
#' @exportMethod get.MatD.nrows
#' @rdname get.MatD.nrows-methods
#' @aliases get.MatD.nrows,MatD-method

setMethod(
  f = "get.MatD.nrows", signature = c(object = "MatD"),
  function(object) {
    return(nrow(object@M))
  }
)
#' Method get.MatD.ncols
#' @name get.MatD.ncols
#' @rdname get.MatD.ncols-methods
#' @exportMethod get.MatD.ncols

setGeneric("get.MatD.ncols", function(object) standardGeneric("get.MatD.ncols"))
#' @rdname get.MatD.ncols-methods
#' @aliases get.MatD.ncols,MatD-method
#' @description It returns the number of columns of a \code{MatD} object
#' @param object  a \code{MatD} object
#' @return An integer, the number of columns.
setMethod(
  f = "get.MatD.ncols", signature = c(object = "MatD"),
  function(object) {
    return(ncol(object@M))
  }
)
#' Method get.MatD.rownames
#' @name get.MatD.rownames
#' @rdname get.MatD.rownames-methods
#' @exportMethod get.MatD.rownames
setGeneric("get.MatD.rownames", function(object) standardGeneric("get.MatD.rownames"))
#' @rdname get.MatD.rownames-methods
#' @aliases get.MatD.rownames,MatD-method
#' @description It returns the labels of the rows of a \code{MatD} object
#' @param object  a \code{MatD} object
#' @return A vector of char, the label of the rows.
setMethod(
  f = "get.MatD.rownames", signature = c(object = "MatD"),
  function(object) {
    return(rownames(object@M))
  }
)
#' Method get.MatD.varnames
#' @name get.MatD.varnames
#' @rdname get.MatD.varnames-methods
#' @exportMethod get.MatD.varnames
setGeneric("get.MatD.varnames", function(object) standardGeneric("get.MatD.varnames"))
#' @rdname get.MatD.varnames-methods
#' @aliases get.MatD.varnames,MatD-method
#' @description It returns the labels of the columns, or the names of the variables, of a \code{MatD} object
#' @param object  a \code{MatD} object
#' @return A vector of char, the labels of the columns, or the names of the variables.
setMethod(
  f = "get.MatD.varnames", signature = c(object = "MatD"),
  function(object) {
    return(colnames(object@M))
  }
)
#' Method get.MatD.main.info
#' @name get.MatD.main.info
#' @rdname get.MatD.main.info-methods
#' @exportMethod get.MatD.main.info
setGeneric("get.MatD.main.info", function(object) standardGeneric("get.MatD.main.info"))
#' @rdname get.MatD.main.info-methods
#' @aliases get.MatD.main.info,MatD-method
#' @description It returns the number of rows, of columns the labels of rows and columns of a \code{MatD} object.
#' @param object  a \code{MatD} object
...
#'
setMethod(
  f = "get.MatD.main.info", signature = c(object = "MatD"),
  function(object) {
    return(list(
      nrows = get.MatD.nrows(object), ncols = get.MatD.ncols(object),
      rownames = get.MatD.rownames(object), varnames = get.MatD.varnames(object)
    ))
  }
)
#' Method get.MatD.stats
#' @name get.MatD.stats
#' @rdname get.MatD.stats-methods
#' @exportMethod get.MatD.stats
setGeneric("get.MatD.stats", function(object, ...) standardGeneric("get.MatD.stats"))

#' @rdname get.MatD.stats-methods
#' @aliases get.MatD.stats,MatD-method
#' @description It returns statistics for each distribution contained in a \code{MatD} object.
#' @param object  a \code{MatD} object
...
#' @examples
#' get.MatD.stats(BLOOD) # the means of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "median") # the medians of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "quantile", prob = 0.5) # the same as median
#' get.MatD.stats(BLOOD, stat = "min") # minima of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "quantile", prob = 0) # the same as min
#' get.MatD.stats(BLOOD, stat = "max") # maxima of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "quantile", prob = 1) # the same as max
#' get.MatD.stats(BLOOD, stat = "std") # standard deviations of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "skewness") # skewness indices of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "kurtosis") # kurtosis indices of the distributions in BLOOD dataset
#' get.MatD.stats(BLOOD, stat = "quantile", prob = 0.05)
#' # the fifth percentiles of distributions in BLOOD dataset
setMethod(
  f = "get.MatD.stats", signature = c(object = "MatD"),
  function(object, stat = "mean", prob = 0.5) {
    r <- get.MatD.nrows(object)
    c <- get.MatD.ncols(object)
    MAT <- matrix(NA, get.MatD.nrows(object), get.MatD.ncols(object))
    rownames(MAT) <- get.MatD.rownames(object)
    colnames(MAT) <- get.MatD.varnames(object)
    for (i in 1:r) {
      for (j in 1:c) {
        if (length(object@M[i, j][[1]]@x) > 0) {
          ...
          if (stat == "skewness") {
            MAT[i, j] <- skewD(object@M[i, j][[1]])
          }
          if (stat == "kurtosis") {
            MAT[i, j] <- kurtD(object@M[i, j][[1]])
          }
          if (stat == "median") {
...
# methods for collating by row or by column two MatDs ----
#' Method WH.bind.row
#' @name WH.bind.row
...
#' @rdname WH.bind.row-methods
#' @aliases WH.bind.row,MatD-method
#' @description It attaches two \code{MatD} objects with the same columns by row.
#' @param object1  a \code{MatD} object
#' @param object2  a \code{MatD} object
#' @return a \code{MatD} object,
#' @examples
#' M1 <- BLOOD[1:3, ]
#' M2 <- BLOOD[5:8, ]
...
setMethod(
  f = "WH.bind.row", signature = c(object1 = "MatD", object2 = "MatD"),
...
#' @rdname WH.bind.col-methods
#' @aliases WH.bind.col,MatD-method
#' @description It attaches two \code{MatD} objects with the same rows by colums.
#' @param object1  a \code{MatD} object
#' @param object2  a \code{MatD} object
#' @return a \code{MatD} object,
#' @examples
...
setMethod(
  f = "WH.bind.col", signature = c(object1 = "MatD", object2 = "MatD"),
  function(object1, object2) {
    ncol1 <- ncol(object1@M)
    ncol2 <- ncol(object2@M)
    nrow1 <- nrow(object1@M)
    ...
    # NewMat=new("MatD", nrows=nrow1,ncols=ncol1+ncol2)
    object1@M <- cbind(object1@M, object2@M)
    return(object1)
  }
)
#' @rdname WH.bind-methods
#' @aliases WH.bind,MatD-method
#' @description It attaches two \code{MatD} objects with the same columns by row, or the same rows by colum.
#' @param object1  a \code{MatD} object
#' @param object2  a \code{MatD} object
...
setMethod(
  f = "WH.bind", signature = c(object1 = "MatD", object2 = "MatD"),
...
# methods for MatD based on the L2 Wasserstein distance between distributions ----
#' Method WH.mat.sum
#' @name WH.mat.sum
...
#' @rdname WH.mat.sum-methods
#' @aliases WH.mat.sum,MatD-method
#' @description It sums two \code{MatD} objects, i.e. two matrices of distributions,
...
setMethod(
  f = "WH.mat.sum", signature = c(object1 = "MatD", object2 = "MatD"),
  # sums two MatD, i.e.  two matrices of distributionsH
  # INPUT:
  # OUTPUT:
    ...
    if (!identical(dim(object1@M), dim(object2@M))) {
      ...
      for (r in 1:nrows1) {
        for (c in 1:ncols1) {
          ...
          TMP <- registerMH(TMP)## aggiusta qui ------
          MATS@M[r, c][[1]] <- new(
            "distributionD",
...
#' @rdname WH.mat.prod-methods
#' @aliases WH.mat.prod,MatD-method
#' @description It is the matrix product of two \code{MatD} objects, i.e. two matrices of distributions,
...
setMethod(
  f = "WH.mat.prod", signature = c(object1 = "MatD", object2 = "MatD"),
  # sums two MatD, i.e.  two matrics of distributionsH
  # INPUT:
  # OUTPUT:
...
# L2 Wasserstein basic operations and basic statistics for matrices of distributionD ----
#' Method WH.vec.sum
#' @name WH.vec.sum
#' @rdname WH.vec.sum-methods
#' @exportMethod WH.vec.sum
setGeneric("WH.vec.sum", function(object, ...) standardGeneric("WH.vec.sum")) # OK weighted sum of a vector of distributionD
#' Method WH.vec.mean
#' @name WH.vec.mean
#' @rdname WH.vec.mean-methods
#' @exportMethod WH.vec.mean
setGeneric("WH.vec.mean", function(object, ...) standardGeneric("WH.vec.mean")) # OK weighted mean of a vector of distributionD
#' Method WH.SSQ
#' @name WH.SSQ
...
#' @rdname WH.vec.sum-methods
#' @aliases WH.vec.sum,MatD-method
#' @description Compute a histogram that is the weighted sum of the set of histograms contained
#' in a \code{MatD} object, i.e. a matrix of histograms, consistent with
#' a set of distributions equipped with a L2 wasserstein metric.
#' @param object  a \code{MatD} object
#' @param ... optional arguments
#' @param w it is possible to add a vector of weights (positive numbers) having the same size of the \code{MatD object},
#' default = equal weights for all cells
#' @return a \code{distributionD} object, i.e. a histogram
#' @examples
#' hsum <- WH.vec.sum(BLOOD)
#' # generate a set of random weights
#' RN <- runif(get.MatD.nrows(BLOOD) * get.MatD.ncols(BLOOD))
#' hsum <- WH.vec.sum(BLOOD, w = RN)
#' ### SUM of distributions ----
setMethod(
  f = "WH.vec.sum", signature = c(object = "MatD"),
  function(object, w = numeric(0)) {
    ...
    if (missing(w)) {
      ...
      if (length(object@M) != length(w)) {
        stop("Weights must have the same dimensions of the input matrix of distributions")
      }
      if (min(w) < 0) {
    ...
    SUM <- new("distributionD", c(0, 0), c(0, 1))
    for (c in 1:ncols) {
      for (r in 1:nrows) {
...
#' @rdname WH.vec.mean-methods
#' @aliases WH.vec.mean,MatD-method
...
#'  the \code{MatD object}, default = equal weights for all
#' @return a \code{distributionD} object, i.e. a histogram
#' @examples
...
setMethod(
  f = "WH.vec.mean", signature = c(object = "MatD"),
  function(object, w = numeric(0)) {
    ...
    w <- w / sum(w)
    if (ncols == 1) {
      MEAN <- MEAN_VA(object, w)## qui c'è la funzione in c da modificare -----
    }
    else {
      w2 <- colSums(w)
      w2 <- w2 / sum(w2)
      MEAN <- w2[1] * MEAN_VA(object[, 1], w[, 1])## Anche qui ----
      for (c in 2:ncols) {
        MEAN <- MEAN + w2[c] * MEAN_VA(object[, c], w[, c])## Anche qui ----
      }
    }
    return(MEAN)
  }
...
#' @rdname WH.SSQ-methods
#' @aliases WH.SSQ,MatD-method
#' @description Compute the sum-of-squares-deviations (from the mean) matrix of a \code{MatD} object, i.e.
...
#' WH.SSQ(BLOOD, w = RN)
setMethod(
  f = "WH.SSQ", signature = c(object = "MatD"),
  function(object, w = numeric(0)) {
    nrows <- nrow(object@M)
    ncols <- ncol(object@M)
    nelem <- nrows * ncols
    ...
    w <- matrix(w, nrows, 1)
    DEV_MAT <- SSQ_RCPP(object, w)## funzione in C da modificare ------
    # w=w/sum(w)
...
#' @rdname WH.var.covar-methods
#' @aliases WH.var.covar,MatD-method
#' @description Compute the variance-covariance matrix of a \code{MatD} object, i.e.
...
setMethod(
  f = "WH.var.covar", signature = c(object = "MatD"),
  function(object, w = numeric(0)) {
    nrows <- nrow(object@M)
    ncols <- ncol(object@M)
    nelem <- nrows * ncols
    ...
    w <- matrix(w, nrows, 1)
    w <- w / sum(w)
    COV_MAT <- WH.SSQ(object, w) ## funzione in C da modificare ------
    return(COV_MAT)
  }
)
#' @rdname WH.correlation-methods
#' @aliases WH.correlation,MatD-method
#' @description Compute the correlation matrix of a \code{MatD} object, i.e.
#' a matrix of values consistent with
#' a set of distributions equipped with a L2 wasserstein metric.
#' @param object  a \code{MatD} object
#' @param ... some optional parameters
...
setMethod(
  f = "WH.correlation", signature = c(object = "MatD"),
  function(object, w = numeric(0)) {
    nrows <- nrow(object@M)
    ncols <- ncol(object@M)
    nelem <- nrows * ncols
    ...
    w <- matrix(w, nrows, 1)
    w <- w / sum(w)
    COV_MAT <- WH.var.covar(object, w) ## funzione in C da modificare ------
...
#' @rdname WH.SSQ2-methods
#' @aliases WH.SSQ2,MatD-method
#' @description Compute the sum-of-squares-deviations (from the mean) matrix using two  \code{MatD} objects having the same number of rows,
...
#' WH.SSQ2(M1, M2, w = RN)
setMethod(
  f = "WH.SSQ2", signature = c(object1 = "MatD", object2 = "MatD"),
  function(object1, object2, w = numeric(0)) {
    ...
    # compute the means
    MEANS1 <- new("MatD", 1, ncols1)
    for (v1 in 1:ncols1) {
      MEANS1@M[1, v1][[1]] <- WH.vec.mean(object1[, v1], w)
    }
    MEANS2 <- new("MatD", 1, ncols2)
    for (v2 in 1:ncols2) {
...
#' @rdname WH.var.covar2-methods
#' @aliases WH.var.covar2,MatD-method
#' @description Compute the covariance matrix using two  \code{MatD} objects having the same number of rows,
#'  It returns a rectangular a matrix of numbers, consistent with
#' a set of distributions equipped with a L2 wasserstein metric.
#' @param object1  a \code{MatD} object
#' @param object2  a \code{MatD} object
...
setMethod(
  f = "WH.var.covar2", signature = c(object1 = "MatD", object2 = "MatD"),
  function(object1, object2, w = numeric(0)) {
    nrows1 <- nrow(object1@M)
    ncols1 <- ncol(object1@M)
...
#' @rdname WH.correlation2-methods
#' @aliases WH.correlation2,MatD-method
#' @description Compute the correlation matrix using two  \code{MatD} objects having the same number of rows,
#'  It returns a rectangular a matrix of numbers, consistent with
#' a set of distributions equipped with a L2 wasserstein metric.
#' @param object1  a \code{MatD} object
#' @param object2  a \code{MatD} object
...
setMethod(
  f = "WH.correlation2", signature = c(object1 = "MatD", object2 = "MatD"),
  function(object1, object2, w = numeric(0)) {
    nrows1 <- nrow(object1@M)
    ncols1 <- ncol(object1@M)
...
#' @rdname is.registeredMH-methods
#' @aliases is.registeredMH,MatD-method
#' @description Checks if a \code{MatD} contains histograms described by the same number of
...
#' @examples
#'
#' ## ---- initialize three distributionD objects mydist1 and mydist2
#' mydist1 <- new("distributionD", c(1, 2, 3), c(0, 0.4, 1))
#' mydist2 <- new("distributionD", c(7, 8, 10, 15), c(0, 0.2, 0.7, 1))
#' mydist3 <- new("distributionD", c(9, 11, 20), c(0, 0.8, 1))
#' ## create a MatD object
#' MyMAT <- new("MatD", nrows = 1, ncols = 3, ListOfDist = c(mydist1, mydist2, mydist3), 1, 3)
...
#' @rdname registerMH-methods
#' @aliases registerMH,MatD-method
#' @description \code{registerMH} method registers a set of distributions of a \code{MatD} object
#' All the
...
#'
#'
#' @param object  A \code{MatD} object (a matrix of distributions)
#' @return A \code{MatD} object, a matrix of distributions sharing the same
...
#' str(MATregistered)
#' #   Formal class 'MatD' [package "HistDAWass"] with 1 slots
#' #   .. @@ M:List of 3
#' #   .. ..$ :Formal class 'distributionD' [package "HistDAWass"] with 4 slots
...
#' #
setMethod(
  f = "registerMH", signature = c(object = "MatD"),
  # register a row or a column vector of qfs of distributionD:
  ...
  function(object) {
    ...
    NEWMAT <- new("MatD", nrows, ncols)
    for (r in 1:nrows) {
      for (c in 1:ncols) {
        x <- compQ_vect(object@M[r, c][[1]], vp = commoncdf)## funzione in C da modificare ------
        # x=numeric(0)
        # for (rr in 1:nr){
        #   x=c(x,compQ(object@M[r,c][[1]],commoncdf[rr]))
        # }
        NEWMAT@M[r, c][[1]] <- new("distributionD", x, commoncdf)
      }
    }
    return(NEWMAT)
  }
...
#' Method Center.cell.MatD Centers all the cells of a matrix of distributions
#' @name Center.cell.MatD
#' @rdname Center.cell.MatD-methods
#' @exportMethod Center.cell.MatD
setGeneric("Center.cell.MatD", function(object) standardGeneric("Center.cell.MatD")) # OK
#' @rdname Center.cell.MatD-methods
#' @aliases Center.cell.MatD,MatD-method
#' @description The function transform a MatD object (i.e. a matrix of distributions),
#' such that each distribution is shifted and has a mean equal to zero
#' @param object a MatD object, a matrix of distributions.
#' @return A \code{MatD} object, having each distribution with a zero mean.
#' @examples
#' CEN_BLOOD <- Center.cell.MatD(BLOOD)
#' get.MatD.stats(BLOOD, stat = "mean")
setMethod(
  f = "Center.cell.MatD", signature = c(object = "MatD"),
  function(object) {
    nr <- get.MatD.nrows(object)
    nc <- get.MatD.ncols(object)
    NM <- object
    for (i in 1:nr) {
      for (j in 1:nc) {
...
## Show overridding ----
#' Method show for MatD
#' @name show-MatD
#' @rdname show-MatD-methods
#' @docType methods
# @aliases show,distributionD-method
# @name show
# @rdname show-MatD
#' @aliases show,MatD-method
#' @description An overriding show method for a \code{MatD} object. The method returns a representation
...
#' print(BLOOD)
#' BLOOD
setMethod("show",## funzione SHOW PER MAT  da modificare ------
  signature(object = "MatD"),
...
#' @docType methods
#' @rdname plot-MatD
#' @aliases plot,MatD-method
#' @description An overloading plot function for a \code{MatD} object. The method returns a graphical representation
...
setMethod(
  "plot", ## funzione in PLOT MAT da modificare ------
  signature(x = "MatD"),
  function(x, y = "missing", type = "HISTO", border = "black", angL = 330) {
    plot.M(x, type = type, border = border, angL = angL)
  }
)
#' Method get.cell.MatD Returns the histogram in a cell of a matrix of distributions
#' @name get.cell.MatD
#' @rdname get.cell.MatD-methods
#' @exportMethod get.cell.MatD
setGeneric("get.cell.MatD", function(object, r, c) standardGeneric("get.cell.MatD")) # OK
#' @rdname get.cell.MatD-methods
#' @aliases get.cell.MatD,MatD-method
...
#' @examples
#' get.cell.MatD(BLOOD, r = 1, c = 1)
setMethod(
  f = "get.cell.MatD", signature = c(object = "MatD", r = "numeric", c = "numeric"),
  function(object, r, c) {
    nr <- get.MatD.nrows(object)
    nc <- get.MatD.ncols(object)
    r <- as.integer(r)
...
#' Method set.cell.MatD assign a histogram to a cell of a matrix of histograms
#' @name set.cell.MatD
#' @rdname set.cell.MatD-methods
#' @exportMethod set.cell.MatD
setGeneric("set.cell.MatD", function(object, mat, r, c) standardGeneric("set.cell.MatD")) # OK
#' @rdname set.cell.MatD-methods
#' @aliases set.cell.MatD,MatD-method
#' @description Assign a histogram data to the r-th row and the c-th column of a matrix of histograms.
#' @param object a distributionD object, a matrix of distributions.
#' @param mat a MatD object, a matrix of distributions.
#' @param r an integer, the row index.
#' @param c an integer, the column index
#'
#' @return A \code{MatD} object.
#' @examples
#' mydist <- distributionD(x = c(0, 1, 2, 3, 4), p = c(0, 0.1, 0.6, 0.9, 1))
#' MAT <- set.cell.MatD(mydist, BLOOD, r = 1, c = 1)
setMethod(
  f = "set.cell.MatD", signature = c(object = "distributionD", mat = "MatD", r = "numeric", c = "numeric"),
  function(object, mat, r, c) {
    nr <- get.MatD.nrows(mat)
    nc <- get.MatD.ncols(mat)
    r <- as.integer(r)
    c <- as.integer(c)
    if (r > nr | r < 1 | c < 1 | c > nc) {
      print("Indices out of range")
